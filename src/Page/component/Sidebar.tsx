...
export default function Sidebar({ }: Props) {
  const classActive = 'border-r-4 border-r-blue-500 border my-6 text-blue-500 rounded-md h-[55px] pt-0 max-w-full text-xl cursor-pointer bg-gray-300 flex items-center duration-300'
  const classNav = 'my-6 rounded-md h-[55px] pt-0 max-w-full text-base cursor-pointer flex items-center duration-300 hover:bg-gray-200'
  return (
    <div className="flex flex-col relative z-20 left-0 rounded-xl mr-7 top-0 z-100 bg-white h-[80%] shadow2 w-[20%]">
